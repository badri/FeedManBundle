...
class SendFeedCommand extends ModeratedCommand
{
    protected function configure()
    {
        $this
            ->setName('mauticplugin:feedman:update')
            ->setAliases(
                array(
                    'mauticplugin:feedman:send',
                    'mauticplugin:feedman:sendfeeds',
                )
            )
            ->setDescription('Send feeds to smart list')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
		...
		$output->writeln('<info>Feedman send feed email status='.date('D').'</info>');
